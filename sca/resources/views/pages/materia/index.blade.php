...
@section('content')
<div class="container" ng-controller="MateriaController as m">
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<table class="table">
					...
					<tr ng-repeat="m in m.materias | filter:search track by m.codigo">
						<td><% m.codigo %></td>
						<td><% m.nombre %></td>
						<td><% m.area %></td>
						<td>
				...
				<input type="hidden" ng-model="m.idCarrera" name="idCarrera" ng-init="m.idCarrera={{$carrera}};m.init();" value></div>
				</div>
			</div>
		</div>
	</div>
