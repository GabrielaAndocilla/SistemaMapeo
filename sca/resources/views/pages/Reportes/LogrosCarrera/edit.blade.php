...
<div class="container">
  <div class="row">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Actualización de Estándares de logro de la Carrera</div>
        <div class="panel-body">

        <form action="{{URL::to('/gestionar/ingreso-logros-carrera').'/'.$datos['rul']->id.'/editar'}}" method="POST" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <select name="rdaUniversidad" class="form-control">
                ...
                @foreach ($datos['rdaUniversidad'] as $ru)
                  @if($ru->id == $datos["rul"]->rda_uni_id)
                    <option value="{{ $ru->id}}" selected>{{$ru->rda_universidad}}</option>
                  @endif
                @endforeach
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input type="text" name="logrordacarreras" value="{{$datos['rul']->logro_carrera}}" class="form-control">
            </div>
          </div>
          <div class="form-group">
