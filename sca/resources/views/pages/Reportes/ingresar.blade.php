...
<div class="container">
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel-heading h-60">Estandares de Logro de la Carrera <a class="link_" href="{{URL::to('/gestionar/ingreso-logros-carrera').'/'.$datos['carrera'].'/insertar'}}"><button class="btn-add" style="float:right">+</button></a></div>
        <div class="panel-body">
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/gestionar/ingreso-logros-carrera').'/'.$rda->id.'/editar'}}"><span class="glyphicon glyphicon-pencil"></span></a>
